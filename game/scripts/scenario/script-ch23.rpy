image noface1:
    ...
    block:
        block:
            choice:
                "images/sayori/noface1.webp"
            choice:
                "images/sayori/noface1b.webp"
        block:
            choice:
                0.075
            choice:
...
label ch23_end:
    ...
    python:
        if renpy.android :
            import os
            try:  
                with open(os.environ['ANDROID_PUBLIC'] + "/have a nice weekend!", "rb") as f: 
                    pass
            except: open(os.environ['ANDROID_PUBLIC'] + "/have a nice weekend!", "w").write("")
            try: os.remove(os.environ['ANDROID_PUBLIC'] + "/hxppy thxughts.webp")
            except: pass
            ...
            try: os.remove(config.basedir + "/hxppy thxughts.webp")
            except: pass
...
label yuri_kill_1:
    ...
    show blood:
        pos (610,485)
    show yuri stab_4 with ImageDissolve("images/yuri/stab/4_wipe.webp", 0.25)
    pause 1.25
    show yuri stab_5
    pause 0.70
    show yuri stab_6:
