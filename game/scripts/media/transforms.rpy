...
define wipeleft = ImageDissolve("images/menu/wipeleft.webp", 0.5, ramplen=64)


define wipeleft_scene = MultipleTransition([
    False, ImageDissolve("images/menu/wipeleft.webp", 0.5, ramplen=64),
    Solid("#000"), Pause(0.25),
    Solid("#000"), ImageDissolve("images/menu/wipeleft.webp", 0.5, ramplen=64),
    True])
...
image noise:
    truecenter
    "images/bg/noise1.webp"
    pause 0.1
    "images/bg/noise2.webp"
    pause 0.1
    "images/bg/noise3.webp"
    pause 0.1
    "images/bg/noise4.webp"
    pause 0.1
    xzoom -1
    "images/bg/noise1.webp"
    pause 0.1
