...
image paper = "images/bg/poem.webp"
image paper_glitch = LiveComposite((1280, 720), (0, 0), "paper_glitch1", (0, 0), "paper_glitch2")
image paper_glitch1 = "images/bg/poem-glitch1.webp"
image paper_glitch2:
    "images/bg/poem-glitch2.webp"
    block:
        yoffset 0
        0.05
        yoffset 20
...
label showpoem(poem=None, music=True, track=None, revert_music=True, img=None, where=i11, paper=None):
    ...
    if not persistent.first_poem:
        ...
        show expression "gui/poem_dismiss.webp" as poem_dismiss:
            xpos 1050 ypos 590
    with Dissolve(1)
    $ pause()
    if img:
