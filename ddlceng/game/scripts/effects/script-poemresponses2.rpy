...
label ch22_y_end:
    ...
    call showpoem (poem_y22, music=False, paper="images/bg/poem_y1.webp", img="yuri 2s")
    y 2q "Ahaha..."
...
label ch23_y_end:
    ...
    call showpoem (poem_y23, track="bgm/5_yuri2.ogg", revert_music=False, paper="images/bg/poem_y2.webp", img="yuri eyes", where=truecenter)
    y "Do you like it??"
